...
const I18N = {
  en: {
    ...
    rbgFreeTier:    '<strong style="color:#a9a4ff">📊 Free tier:</strong> 50 API calls/month. Your quota resets every month on the date you first started using it.',
  ...
  hi: {
    ...
    rbgFreeTier:    '<strong style="color:#a9a4ff">📊 मुफ़्त सीमा:</strong> हर महीने 50 API कॉल। आपकी सीमा हर महीने उसी तारीख को रीसेट होती है जिस दिन आपने पहली बार इसका उपयोग शुरू किया था।',
  ...
  bn: {
    ...
    rbgFreeTier:    '<strong style="color:#a9a4ff">📊 ফ্রি টিয়ার:</strong> মাসে ৫০টি API কল। আপনি প্রথম যেদিন এটি ব্যবহার শুরু করেছিলেন, প্রতি মাসে সেই তারিখেই আপনার কোটা রিসেট হয়।',
